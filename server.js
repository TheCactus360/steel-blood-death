...
// Este objeto guardará las salas mientras el servidor esté encendido
let batallasActivas = {}; 

// Ruta para crear o unirse a una batalla
app.post('/api/batalla/unirse', (req, res) => {
    ...
    if (!batallasActivas[codigo]) {
        ...
        console.log(`${nombre} se ha unido a la sala ${codigo}`);
